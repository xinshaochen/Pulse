...
//	for(i=0;i<15;i++)
//	{
//		sprintf(p,"192.168.%d.255\0",i);
		ConnectSendCode(Broad, 2333, 4, meDev.IP, sizeof(meDev.IP));	
//		delay_ms(100);
//	}
...
u8 f;
	if(GetIPID==true)
	{
		...
		bufid[i++] = '\0';
		meDev.ID =  atoi((const char *)bufid);
		...
		if(meDev.IP[0]==192&&meDev.IP[1]!=0&&meDev.IP[2]!=0&&meDev.IP[3]!=0)
		{
			GetIPID=false;
...
void SendMeIPEvent(UartEvent e)
{
	...
	ConnectSendCode(sendIPstr,2333,Alive,meDev.IP,sizeof(meDev.IP));
	e->noack();//不要自动应答
}
//============================================================================================================
//============================================================================================================
